...
Flowcell: <span class="badge"> `r params$flowcell` </span>          
User ID: <span class="badge"> `r params$user` </span>             
...
table2_caption <- ifelse(params$sequencer != "Illumina", 
                         ...
                         "GC-content, base content per cycle, 'mean' q-score, q-score per cycle, duplication rate and k-mer counts (k = 3). The q-scores 10, 20, 30, 40 are in red.")
gc_df %>%
	dplyr::arrange(file) %>%
