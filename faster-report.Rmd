...
Report generated on `r format.Date(Sys.time())` at `r params$author`. All fastq data is calculated with the [faster](https://github.com/angelovangel/faster) and [fastkmers](https://github.com/angelovangel/fastkmers) programs.
...
stats_headers <- c("filename", "num_reads", "bases", "n_bases", 
...
df <- utils::read.table(text = stats, col.names = stats_headers) %>% 
