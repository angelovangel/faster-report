...
Generated at <span class="badge">`r params$author`</span> <span class="badge">`r format.Date(Sys.time())` </span>   
...
This is <span class="badge">`r params$sequencer`</span> sequencing data. The report contains 
<blockquote>  
