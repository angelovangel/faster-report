...
dfcols <- c("file", "reads", "bases", "n_bases", "min_len", "max_len", "N50", "Q20_percent", "Q30_percent")
# } else {
...
kableExtra::kbl(
  ...
  # ) %>%
  kable_minimal(lightable_options = 'hover', full_width = TRUE)
...
# ) %>%
#   DT::formatRound(2:8, 0) %>%
#   DT::formatRound(9:10, 2)
