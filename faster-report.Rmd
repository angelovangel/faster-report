...
Github repository: <a href="https://github.com/angelovangel/faster-report" target="_blank" style="color: #4e5256ff;">faster-report</a> | commit: `r tryCatch(system("git rev-parse --short HEAD", intern = TRUE, ignore.stderr = TRUE), error = function(e) "NA")`
</p>
